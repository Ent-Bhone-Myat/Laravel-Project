...
// Moon Welcome URl
Route::get('/', [MoonController::class, 'home'])->name('moon.home');
Route::get('/shop/{id}', [MoonController::class, 'shop'])->name('moon.shop');
...
Route::middleware([
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::prefix('admin/account')->group(function(){
            ...
            Route::get('/change/{id}', [AdminController::class, 'changeUser'])->name('change.user');
    ...
    Route::middleware(['user'])->group(function () {
        ...
        Route::get('/cart/product/clear', [CartController::class, 'cartClear'])->name('cart.clear');
