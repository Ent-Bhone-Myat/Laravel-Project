...
@section('breadc')
    ...
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Product Create</h6>
    </nav>
@endsection
@section('content')
                    ...
                    <form action="{{ route('product.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="productSeries" id="productSeries"
                                class="form-control @error('productSeries') is-invalid @enderror" placeholder="product series"
                                value="{{ old('productSeries') }}">
                            @error('productSeries')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="productPrice" id="productPrice"
                                class="form-control @error('productPrice') is-invalid @enderror" placeholder="product price"
