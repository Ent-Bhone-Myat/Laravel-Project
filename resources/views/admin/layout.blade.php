    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href= "{{ url('/') }}">
                ...
                <span class="ms-1 font-weight-bold">THE MOON</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="category" class="nav-content collapse p-2" data-bs-parent="#sidebar-nav"
                        style="list-style-type: none; margin-left: 50px; font-size: 13px">
                        <li class="mb-3">
                ...
                <li class="nav-item">
                    ...
                    <ul id="product" class="nav-content collapse p-2" data-bs-parent="#sidebar-nav"
                        style="list-style-type: none; margin-left: 50px; font-size: 13px">
                        <li class="mb-3">
                ...
                <li class="nav-item">
                    ...
                    <ul id="order" class="nav-content collapse p-2" data-bs-parent="#sidebar-nav"
                        style="list-style-type: none; margin-left: 50px; font-size: 13px">
                        <li>
                ...
                <li class="nav-item">
                    ...
                    <ul id="account" class="nav-content collapse p-2" data-bs-parent="#sidebar-nav"
                        style="list-style-type: none; margin-left: 50px; font-size: 13px">
                        <li class="mb-3">
                    ...
                    <a class="nav-link collapsed" data-bs-target="#contact" data-bs-toggle="collapse"
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M21 8V7l-3 2l-3-2v1l2.72 1.82a.5.5 0 0 0 .55 0zm1-5H2C.9 3 0 3.9 0 5v14c0 1.1.9 2 2 2h20c1.1 0 1.99-.9 1.99-2L24 5c0-1.1-.9-2-2-2M8 6c1.66 0 3 1.34 3 3s-1.34 3-3 3s-3-1.34-3-3s1.34-3 3-3m6 12H2v-1c0-2 4-3.1 6-3.1s6 1.1 6 3.1zm7.5-6h-7c-.28 0-.5-.22-.5-.5v-5c0-.28.22-.5.5-.5h7c.28 0 .5.22.5.5v5c0 .28-.22.5-.5.5" />
                            </svg>
                        </div>
                        <span class="nav-link-text ms-1">Contact</span>
                    </a>
                    <ul id="contact" class="nav-content collapse p-2" data-bs-parent="#sidebar-nav"
                        style="list-style-type: none; margin-left: 50px; font-size: 13px">
                        <li class="mb-3">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="#" class="font-weight-bold" target="_blank">Ent Bhone Myat</a>
                                for a better web.
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="#" class="nav-link text-muted">Ent Bhone Myat</a>
                                </li>
                                <li class="nav-item">
